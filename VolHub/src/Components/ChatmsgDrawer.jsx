...
import { FaCloudDownloadAlt, FaLongArrowAltLeft, FaPhoneAlt } from "react-icons/fa";
...
import { FaCamera, FaFilePdf, FaFileWord, FaRegFaceGrin } from "react-icons/fa6";
...
function ChatmsgDrawer({reciverid,conversationid,receiverName}) {
      ...
      <Box className="flex flex-col">
          ...
          <Box className="flex items-center p-2 justify-between bg-customwhite rounded-t-[50px]">
            <Box className="flex items-center  gap-3 ml-3">
              ...
              <Avatar src=""/>
              <Box>
              <Text>{receiverName}</Text> {/* Display receiver's name */}
              <Text>Online</Text>
