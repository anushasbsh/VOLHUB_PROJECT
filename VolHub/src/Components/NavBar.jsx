  ...
  return (
    <nav className="p-4 fixed top-0 left-0 right-0 z-20">
      <div className="container mx-auto flex items-center justify-between">
        ...
        {/* Navigation Links */}
        <div className="flex space-x-6 relative left-[-8rem]"> {/* Adjusted left positioning to move links left */}
          ...
          <div className="relative group">
            ...
            <div className="absolute left-0 hidden pr-0 mt-2 w-56 bg-white text-gray-800 rounded-md shadow-lg group-hover:block">
              <div className="p-4">
