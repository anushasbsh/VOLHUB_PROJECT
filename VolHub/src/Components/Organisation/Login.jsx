        ...
        >
           ...
           <Stack spacing={4} align="center" mb={4}>
            <Image 
              src={userIcon} 
              alt="User Icon" 
              width="6.5rem"  // Set width here
              height="5rem"    // Set height here
            />
            ...
            <Stack spacing={4}>
              <FormControl isRequired>
                ...
                <Input
                  ...
                  focusBorderColor="#2980B9" // Custom focus border color
              ...
              <Button
                ...
                width="full"
                mt={4}
                _hover={{ bg: "#1f6f91" }} // Darker shade on hover
              >
                Login
              </Button>
            </Stack>
          ...
          <Stack mt={4} spacing={4} textAlign="center">
            <Box color="#d5d8dc">
              ...
              <Link to="/orgsignup" style={{ color: '#3b82f6' }}>Register</Link>
            </Box>
          </Stack>
        </Box>
      </Box>
