...
import backgroundImage from '../../assets/Images/land2.jpg'; 
const LandingPage = () => {
  ...
  return (
    <div 
      className="flex flex-col min-h-screen bg-[#f7f4f1] bg-cover bg-center"
      style={{ backgroundImage: `url(${backgroundImage})` }} // Use the imported image
    >
      <NavBar />
      <main className="flex flex-col md:flex-row items-center justify-center flex-1 text-center p-6">
